...
install_name_tool -change "@@HOMEBREW_PREFIX@@/opt/libkrunfw/lib/libkrunfw.4.dylib" "@rpath/libkrunfw.4.dylib"  "out/bin/revm-arm64"
install_name_tool -change "@@HOMEBREW_PREFIX@@/opt/libkrun/lib/libkrun.dylib" "@rpath/libkrun.dylib"  "out/bin/revm-arm64"
